"""
Telegram бот "Grave Shop" - ИСПРАВЛЕННАЯ ВЕРСИЯ 2.0
Исправлено:
- Кнопка "Мои реквизиты" работает
- Оплата картой/СБП работает после добавления реквизитов
- Кнопка удаления аккаунтов работает
- В объявлениях только первые 4 цифры номера
- Показывается юзернейм продавца
- В списке объявлений только название и цена
- В верификациях только кнопки (без текста)
"""
